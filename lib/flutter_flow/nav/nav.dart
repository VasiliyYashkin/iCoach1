...
class AppStateNotifier extends ChangeNotifier {
  ICoachFirebaseUser? initialUser;
  ICoachFirebaseUser? user;
  ...
  void update(ICoachFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'clientProgress',
              requireAuth: true,
              builder: (context, params) => ClientProgressWidget(),
            ),
            FFRoute(
              name: 'ClientProfile',
              path: 'clientProfile',
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => ClientDetailPageWidget(
                clientID: params.getParam(
                    'clientID', ParamType.DocumentReference, false, ['users']),
            ...
            FFRoute(
              ...
              path: 'addPhotoesPage',
              requireAuth: true,
              builder: (context, params) => AddPhotoesPageWidget(
            ...
            FFRoute(
              ...
              path: 'selectTracking',
              requireAuth: true,
              builder: (context, params) => SelectTrackingWidget(
                user: params.getParam(
                    'user', ParamType.DocumentReference, false, ['users']),
              ),
            ),
            FFRoute(
              name: 'MealTrackingSwitch',
              path: 'mealTrackingSwitch',
              requireAuth: true,
              asyncParams: {
                'user': getDoc(['users'], UsersRecord.serializer),
              },
              builder: (context, params) => MealTrackingSwitchWidget(
            ...
            FFRoute(
              ...
              path: 'clientHomePage',
              requireAuth: true,
              builder: (context, params) => ClientHomePageWidget(),
            ),
            FFRoute(
              name: 'CheckPage',
              path: 'checkPage',
              requireAuth: true,
              builder: (context, params) => CheckPageWidget(),
            )
