...
final parametersBuilderMap =
  ...
  'CoachProfile': ParameterData.none(),
  'ClientProgress': ParameterData.none(),
  'ClientProfile': ParameterData.none(),
  'Clients': ParameterData.none(),
  'ComparePage': (data) async => ParameterData(
        allParams: {
  ...
  'ClientDetailPage': (data) async => ParameterData(
        allParams: {
          'clientID': getParameter<DocumentReference>(data, 'clientID'),
          'indexTab': getParameter<int>(data, 'indexTab'),
        },
      ),
  'Onboarding': ParameterData.none(),
  'PlanPage': ParameterData.none(),
  'AddPhotoesPage': (data) async => ParameterData(
        allParams: {
          'user': getParameter<DocumentReference>(data, 'user'),
        },
      ),
  'SelectTracking': (data) async => ParameterData(
        allParams: {
          'user': getParameter<DocumentReference>(data, 'user'),
        },
      ),
  'MealTrackingSwitch': (data) async => ParameterData(
        allParams: {
